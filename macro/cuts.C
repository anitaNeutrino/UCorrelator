...
TCut notHical1("Hical2::isHical(eventNumber, header->triggerTime, FFTtools::wrap(anitaLocation.heading - peak[0][0].phi, 360))!=1");
TCut notHical2("Hical2::isHical(eventNumber, header->triggerTime, FFTtools::wrap(anitaLocation.heading - peak[0][0].phi, 360))!=1");
