...
namespace UCorrelator
{
  ...
  class AnalysisConfig
  {
    public: 
       ...
       * This is only used for WAIS right now since hte LDB pulsing was so variable. 
       * */
      class Pulser
      {
        public: 
      ...
      Pulser wais_hpol, wais_vpol; 

      /** For LDB pulser, we rely on a histogram generated by e.g. macros/makeLDBSelection.C" 
       * */
      TH2* ldb_hist; 
      int ldb_max_run; 
